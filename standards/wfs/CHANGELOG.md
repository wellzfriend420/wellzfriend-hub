...
- Dashboard、Report、Executive Reportの3レベルと、それぞれの目的・利用場面・品質基準
- システムの目的、利用者、提出先に応じて必要な成果物だけを選択する判断手順

### Changed

- 画面、分析資料、提出資料の役割を分離し、一つの画面へすべての役割を集約しない方針を明文化
- 3レベル構成を必須要件ではなく、規模と用途に応じて採用する設計指針として定義
- 複数の成果物を採用する場合も、数値の正本となるデータ・計算ロジックを共通化する原則を追加
